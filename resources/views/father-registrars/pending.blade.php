...
@section("content")
  ...
  <div class="card card-secondary">
      <div class="card-header">
          <h3 class="card-title">List of Pending Father</h3>
      </div>
      <div class="card-body">
            ...
            <div class="col-md-12 menu">
              <nav class="navecation" style="margin-left:-40px;margin-top:20px;">
                <ul id="navi">
                  ...
                  <li><a class="menu {{(request()->is('father-registrars*')) ? 'current' : '' }}" href="{{route('father-registrars.pending')}}">Pending ({{$countPending}})</a></li>
...
<script>
  ...
  document.getElementById('pagination').onchange = function() { 
    ...
    window.location = "{{URL::route('father-registrars.pending')}}?items=" + this.value; 
  }; 
        ...
        if(allVals.length <= 0)  {  
          alert("Please select row."); 
            ...
            if(check == true){  
                ...
                $.ajax({
                    url: '{{ url('father-registrarsApproveAll') }}',
                    type: 'get',
      ...
      if(delVals.length <= 0)  {  
        alert("Please select row."); 
          ...
          if(checkDelRow == true){  
              ...
              $.ajax({
                  url: '{{ url('father-registrarsRejectAll') }}',
                  type: 'get',
