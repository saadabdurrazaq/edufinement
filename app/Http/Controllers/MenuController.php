...
class MenuController extends Controller
{
    ...
    {
        $menu = Menus::where('name', 'Top Menu')->with('items')->first();
        $public_menu = $menu->items;

        return view('layouts.frontend.home.index', compact('public_menu'))->with(array('public_menu' => $public_menu)); //admin mengacu ke table admin di phpmyadmin
    }
