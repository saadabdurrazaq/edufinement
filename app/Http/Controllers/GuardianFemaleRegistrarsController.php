...
class GuardianFemaleRegistrarsController extends Controller
{
    ...
    */
    ...
    {
        return view('guardianfemale-registrars.register');
    }
    ...
    public function store(Request $request) 
    {
        ...
        return redirect()->route('guardianfemale-regis')->with('status', 'Registration successfull. Thank you for registration! You will be notified if your child is approved');
    }
